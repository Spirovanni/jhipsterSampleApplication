...
describe('Service Tests', () => {
    ...
    describe('DisciplineMySuffix Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(DisciplineMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/disciplines/' + 123);
            });
            it('should return DisciplineMySuffix', () => {

                let entity: DisciplineMySuffix;
                service.find(123).subscribe((_entity: DisciplineMySuffix) => {
                    entity = _entity;
                });
