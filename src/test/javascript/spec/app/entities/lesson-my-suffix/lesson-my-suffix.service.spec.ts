...
describe('Service Tests', () => {
    ...
    describe('LessonMySuffix Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(LessonMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/lessons/' + 123);
            });
            it('should return LessonMySuffix', () => {

                let entity: LessonMySuffix;
                service.find(123).subscribe((_entity: LessonMySuffix) => {
                    entity = _entity;
                });
