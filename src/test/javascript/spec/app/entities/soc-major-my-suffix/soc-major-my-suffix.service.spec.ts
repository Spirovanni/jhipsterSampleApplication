...
describe('Service Tests', () => {
    ...
    describe('SocMajorMySuffix Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(SocMajorMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/soc-majors/' + 123);
            });
            it('should return SocMajorMySuffix', () => {

                let entity: SocMajorMySuffix;
                service.find(123).subscribe((_entity: SocMajorMySuffix) => {
                    entity = _entity;
                });
