...
describe('Service Tests', () => {
    ...
    describe('ProgramMySuffix Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(ProgramMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/programs/' + 123);
            });
            it('should return ProgramMySuffix', () => {

                let entity: ProgramMySuffix;
                service.find(123).subscribe((_entity: ProgramMySuffix) => {
                    entity = _entity;
                });
