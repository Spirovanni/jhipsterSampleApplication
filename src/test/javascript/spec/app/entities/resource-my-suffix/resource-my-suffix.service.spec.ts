...
describe('Service Tests', () => {
    ...
    describe('ResourceMySuffix Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(ResourceMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/resources/' + 123);
            });
            it('should return ResourceMySuffix', () => {

                let entity: ResourceMySuffix;
                service.find(123).subscribe((_entity: ResourceMySuffix) => {
                    entity = _entity;
                });
