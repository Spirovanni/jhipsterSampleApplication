...
describe('Service Tests', () => {
    ...
    describe('SocSpecificMySuffix Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(SocSpecificMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/soc-specifics/' + 123);
            });
            it('should return SocSpecificMySuffix', () => {

                let entity: SocSpecificMySuffix;
                service.find(123).subscribe((_entity: SocSpecificMySuffix) => {
                    entity = _entity;
                });
