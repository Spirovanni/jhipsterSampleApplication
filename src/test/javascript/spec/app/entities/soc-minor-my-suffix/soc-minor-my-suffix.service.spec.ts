...
describe('Service Tests', () => {
    ...
    describe('SocMinorMySuffix Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(SocMinorMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/soc-minors/' + 123);
            });
            it('should return SocMinorMySuffix', () => {

                let entity: SocMinorMySuffix;
                service.find(123).subscribe((_entity: SocMinorMySuffix) => {
                    entity = _entity;
                });
