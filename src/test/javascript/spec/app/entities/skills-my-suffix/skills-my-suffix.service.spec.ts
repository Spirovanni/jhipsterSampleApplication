...
describe('Service Tests', () => {
    ...
    describe('SkillsMySuffix Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(SkillsMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/skills/' + 123);
            });
            it('should return SkillsMySuffix', () => {

                let entity: SkillsMySuffix;
                service.find(123).subscribe((_entity: SkillsMySuffix) => {
                    entity = _entity;
                });
