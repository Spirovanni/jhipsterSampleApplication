...
import io.github.jhipster.application.domain.enumeration.Group;
/**
...
public class SocSpecificResourceIntTest {
    ...
    public void updateSocSpecific() throws Exception {
        ...
        // Disconnect from session so that the updates on updatedSocSpecific are not directly saved in db
        em.detach(updatedSocSpecific);
        updatedSocSpecific
